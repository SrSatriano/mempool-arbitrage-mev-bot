# Arquitetura — Bot educacional de arbitragem MEV no mempool

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Listener de pending txs, avaliação de lucro simulado e avisos éticos claros.
...
|------------|------------------|
| Listener | Listener de transações pendentes |
| Avaliação | Avaliação de profit teórico |
| Documentação | Documentação ética e limitações |
| Configuração | Configuração TOML |
| Simulador | Simulador local |
